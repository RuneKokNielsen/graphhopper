...
\begin{minipage}{0.6\linewidth}
	\hspace*{-1in}
	\iffalse	\includegraphics[width=10cm]{nci1} \fi
...
\begin{minipage}{0.6\linewidth}
	\hspace*{-1in}
	\iffalse	\includegraphics[width=10cm]{nci109} \fi
...
\begin{minipage}{0.6\linewidth}
	\hspace*{-1in}
	\iffalse	\includegraphics[width=10cm]{collab} \fi
	\captionof{figure}{Collab results}
	\label{fig:collab}
\end{minipage}
\begin{minipage}[c]{0.5\linewidth}
	...
	\begin{tabular}{c|c|c|c}
		...
		DPK & - & - & 
	\end{tabular}
	\captionof{table}{Collab results}
	\label{table:collab}
\end{minipage}
