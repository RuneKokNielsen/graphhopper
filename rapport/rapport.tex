...
When inspecting the results of Collab (labelled) we see that GH outperforms WL. We also see a minor increase in GH's performance when adding gaps, but it is still within the standard deviation. \\
=======
\textbf{Collab (labelled)}\\
>>>>>>> 92218ab695468b1616a265f17269c9384383edd9
\begin{minipage}{0.6\linewidth}
	\hspace*{-1in}
...
\begin{minipage}[c]{0.5\linewidth}
	...
	\begin{tabular}{c|c|c|c}
		Kernel & Node kernel & Gaps & Result\\
		\hline
		GH & Dirac & 0 & \textbf{78.6580 (std. 0.2647)}\\
		GH & Dirac & 1 & \textbf{78.8960 (std. 0.2084)}\\
		GH & Dirac & 2 & \textbf{79.0620 (std. 0.2461)} \\
		GH & Dirac & 3 & \textbf{78.9980 (std. 0.3615)}\\
...
Opposite of the results from Collab (labelled), here WL outperforms GH. Gaps seems to have very small to none effect on the performance of GH. \\
\begin{minipage}{0.6\linewidth}
	\hspace*{-1in}
...
\begin{minipage}[c]{0.5\linewidth}	
	...
	\begin{tabular}{c|c|c|c}
		Kernel & Node kernel & Gaps & Result\\
		\hline
		GH & Dirac & 0 & \textbf{49.9933 (std. 0.3150)} \\
		GH & Dirac & 1 & \textbf{50.3133 (std. 0.5297)} \\
		GH & Dirac & 2 & \textbf{50.6133 (std. 0.6739)} \\
		GH & Dirac & 3 & \textbf{50.2067 (std. 0.5043)} \\
