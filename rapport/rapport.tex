...
Let $v.children$ be the children of $v$ in $G_{\tilde{v}}$. A recursive algorithm for computing $\mathfrak{D}_{\tilde{v}}$ can then be written out as in figure \ref{algorithm:d}.
