...
\begin{minipage}{0.6\linewidth}
\hspace*{-1in}
\iffalse	\includegraphics[width=10cm]{reddit_binary_unlabelled_k_wl} \fi
\captionof{figure}{Reddit binary (unlabelled) K gray scale for WL.}
\label{fig:reddit_binary_unlabelled_k_wl}
\end{minipage}
