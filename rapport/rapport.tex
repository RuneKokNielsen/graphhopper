...
\begin{minipage}{0.6\linewidth}
	\hspace*{-1in}
\iffalse	\includegraphics[width=10cm]{enzymes_symmetrized} \fi
...
\begin{minipage}{0.6\linewidth}
	\hspace*{-1in}
	\iffalse	\includegraphics[width=10cm]{airways} \fi
...
Collab (unlabelled) & Dirac & 63.3100 (std. 0.0750) & & & & &  \\
		IMDB Binary (labeled) & Dirac & 71.37 (std. 0.8486) & 71.89 (std. 0.7824) & & & & 72.53 (std. 0.5229) \\
