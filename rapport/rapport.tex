...
\end{equation}
The complexity shown in (\ref{eq:tc_gaps_1}) does not include adding the new edges to the graph, we need to do this can be done by iterating through the list of the nodes with the new parents.
\begin{equation}
\label{eq:tc_gaps_2}
